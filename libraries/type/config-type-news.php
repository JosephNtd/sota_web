...
/* Hình thức thanh toán *-/
    ...
    /* Tính năng nổi bật */
$nametype = "tinh-nang";
$config['news'][$nametype]['title_main'] = "Tính năng nổi bật";
$config['news'][$nametype]['check'] = array('noibat' => 'Nổi bật');
$config['news'][$nametype]['dropdown'] = false;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['view'] = true;
...
$config['news'][$nametype]['gallery'] = array(
    $nametype => array(
        "title_main_photo" => "Hình ảnh tính năng",
        "title_sub_photo" => "Hình ảnh",
        "number_photo" => 3,
        "images_photo" => true,
        "cart_photo" => true,
    ...
    "video" => array(
        ...
        "video_photo" => true,
        "file_photo" => true,
        "file_type_photo" => '.mp4|.webm|.mov|.MP4|.WEBM|.MOV',
        // "images_photo" => true,
        // "width_photo" => 640,
        // "height_photo" => 360,
        // "thumb_photo" => '320x180x1',
        // "img_type_photo" => '.jpg|.png|.jpeg|.JPG|.PNG|.JPEG'
    )
);
...
/* 
   FAQ — Câu hỏi thường gặp (cho trang Liên hệ)
   tenvi   = câu hỏi
   noidungvi = câu trả lời (CKEditor)
 */
$nametype = "faq";
