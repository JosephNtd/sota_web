                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                ...
                                <div class="card-body card-article">
                                    ...
                                    <?php if (isset($config['news'][$type]['video']) && $config['news'][$type]['video'] == true) { ?>
                                        ...
                                        <!-- Cho upload video local lên -->
                                        <div class="form-group">
                                            <label for="taptin">Hoặc tải file video từ máy tính (.mp4):</label>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="taptin" id="taptin">
                                                <label class="custom-file-label" for="taptin">Chọn file video</label>
                                            </div>
                                            <?php if (!empty($item['taptin'])) { ?>
                                                <div class="mt-2 text-sm text-success">
                                                    <i class="fas fa-check-circle mr-1"></i> Đã có video local: <strong><?= @$item['taptin'] ?></strong>
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <!-- end -->
